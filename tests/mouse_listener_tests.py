...
class MouseListenerTest(EventTest):
    ...
    def test_move(self):
        ...
        self.assert_cumulative(
            'Failed to register movement', on_move=lambda a, b: True
        )
    ...
    def test_click_left(self):
        ...
        self.assert_stop(
            ...
            on_click=lambda x, y, button, pressed: (
                not (pressed and button == pynput.mouse.Button.left)
            ),
        )
    ...
    def test_click_right(self):
        ...
        self.assert_stop(
            ...
            on_click=lambda x, y, button, pressed: (
                not (pressed and button == pynput.mouse.Button.right)
            ),
        )
    ...
    def test_scroll_up(self):
        ...
        self.assert_stop(
            ...
            on_scroll=lambda x, y, dx, dy: not (dy > 0),
        )
